public class PersonInfo2 {
    ...
    public static String firstName = "Alexander";
    public static String lastName = "Moussa";
    public static int studentNo = 300018112;
    public static String description = "Likes coding";
